...
import 'detailed_meatcart_view_screen.dart';

class MeatCartScreen extends StatefulWidget {
  List<MeatCart> meatcart;
  MeatCartScreen({
    Key? key,
    required this.meatcart,
  }) : super(key: key);

  @override
  State<MeatCartScreen> createState() => _MeatCartScreenState();
}

class _MeatCartScreenState extends State<MeatCartScreen> {
  ScrollController _scrollController = ScrollController();
  @override
  Widget build(BuildContext context) {
    print("the meatcart lenght is ${widget.meatcart.length}");
    return Scaffold(
        // appBar: AppBar(
      ...
      child: Column(
        children: [
          ...
          ListView.builder(
              shrinkWrap: true,
              itemCount: widget.meatcart.length,
              itemBuilder: (context, index) {
                MeatCart cartdata = widget.meatcart[index];
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: ((context) => DetailedMeatCartViewScreen(
                                    meatCartdetails: cartdata,
                                  ))));
                    },
                    child: Container(
