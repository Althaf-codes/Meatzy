...
class LiveStockDeliveredOrderScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          ...
          ListView.builder(
              shrinkWrap: true,
              itemCount: userlivestockorders.length,
              itemBuilder: (context, index) {
                UserLiveStockOrder orderdata = userlivestockorders[index];
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                fit: BoxFit.cover,
                                imageUrl: orderdata.orderProductImage!,
                            ...
                            child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ' ${orderdata.deliveryDate.toString()} ',
                                      maxLines: 1,
